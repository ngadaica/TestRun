    ...
    public class EmailService
    {
        ...
        private string GetDesignatedApproverEmail(string deptCode, string role, int stepIndex)
        {
            ...
            switch (stepIndex)
            {
                ...
                case 1: return "phamduc.anh@brother-bivn.com.vn"; //Doan.PhamCong@brother-bivn.com.vn
        ...
        public void SendApprovalCompletedNotification(Request request, WorkflowStep completedStep, User approver)
        {
            try
            {
                const string notificationEmail = "phamduc.anh@brother-bivn.com.vn"; //Hoangthi.Minh@brother-bivn.com.vn
